...
public class PlayerStatUI : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        staminaSlider.maxValue = GameManager.GetGameManager().playerController.getMaxStamina;
        staminaSlider.value = staminaSlider.maxValue;
        staminaValue = staminaSlider.value;

        healthSlider.maxValue = GameManager.GetGameManager().playerController.GetMaxHealth();
    ...
    public void UpdateHPUIElement( )
    {
        ...
        var HP = GameManager.GetGameManager().playerController.GetHealth();
    ...
    public void UpdateStaminaUIElement()
    {
        ...
        var stamina = GameManager.GetGameManager().playerController.getStamina;
